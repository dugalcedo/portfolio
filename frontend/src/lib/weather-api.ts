import { VarObj, WeatherUnit } from './types.ts'
...
export async function fetchLocations(params: VarObj) {
	try {
...
export async function fetchForecast(params: VarObj) {
	try {
...
export function secondsToHours(n: number) {
...
export function formatN(n: number, unit: WeatherUnit) {
	switch (unit) {
		case 'F':
...
const weatherCodes: Record<string, VarObj> = {
	"0":{
		"day":{
			"description":"Sunny",
